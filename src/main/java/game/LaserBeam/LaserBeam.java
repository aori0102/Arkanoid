...
public class LaserBeam extends MonoBehaviour {
    ...
    private static final double LASER_SPEED = 1000; // Movement speed of the laser
    private final Layer[] colliderLayers = {Layer.Boss, Layer.Brick}; // Layers laser can collide with
