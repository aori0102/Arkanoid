...
public class PauseButton extends MonoBehaviour{
    ...
    private MenuButton.ButtonState buttonState = MenuButton.ButtonState.Idle;
    private MenuButton.ButtonState buttonPrevState = null;
    ...
    private void stateHandler() {
        buttonUI.setAdditionalOnClick(() -> {
            buttonState = MenuButton.ButtonState.Clicked;
            System.out.println(buttonState);

        });
        buttonUI.setOnExit(() -> {
            buttonState = MenuButton.ButtonState.Idle;
            System.out.println(buttonState);

        });
        buttonUI.setOnUp(() -> {
            buttonState = MenuButton.ButtonState.Released;
            System.out.println(buttonState);

        });
        buttonUI.setOnDown(() -> {
            buttonState = MenuButton.ButtonState.Pressed;
            System.out.println(buttonState);

        });
        buttonUI.setOnEnter(() -> {
            buttonState = MenuButton.ButtonState.Hover;
            System.out.println(buttonState);
        });
    }
