...
public class OptionsButton extends MonoBehaviour {
    ...
    private StartButton.ButtonState buttonState = StartButton.ButtonState.Idle;
    private StartButton.ButtonState buttonPrevState = null;
    ...
    private void stateHandler() {
        buttonUI.setAdditionalOnClick(() -> {
            buttonState = StartButton.ButtonState.Clicked;
            System.out.println(buttonState);

        });
        buttonUI.setOnExit(() -> {
            buttonState = StartButton.ButtonState.Idle;
            System.out.println(buttonState);

        });
        buttonUI.setOnUp(() -> {
            buttonState = StartButton.ButtonState.Released;
            System.out.println(buttonState);

        });
        buttonUI.setOnDown(() -> {
            buttonState = StartButton.ButtonState.Pressed;
            System.out.println(buttonState);

        });
        buttonUI.setOnEnter(() -> {
            buttonState = StartButton.ButtonState.Hover;
            System.out.println(buttonState);
        });
    }
